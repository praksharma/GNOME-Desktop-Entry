...
import os
import glob
from utils import root_window_selector, themed_widget,  custom_tk
...
if __name__ == "__main__":#
    # change the behaviour of a placeholder between tk and ttk based on theme flag
    TK = custom_tk(theme)
    # Get root window based on the theme flag
